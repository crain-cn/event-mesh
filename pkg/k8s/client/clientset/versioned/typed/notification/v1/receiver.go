...
type ReceiverInterface interface {
	...
	UpdateStatus(ctx context.Context, receiver *v1.Receiver, opts metav1.UpdateOptions) (*v1.Receiver, error)
...
func newReceivers(c *NotificationV1Client) *receivers {
	return &receivers{
		client: c.RESTClient(),
	}
}
...
func (c *receivers) UpdateStatus(ctx context.Context, receiver *v1.Receiver, opts metav1.UpdateOptions) (result *v1.Receiver, err error) {
	result = &v1.Receiver{}
	err = c.client.Put().
		Resource("receivers").
		Name(receiver.Name).
...
func (c *receivers) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
